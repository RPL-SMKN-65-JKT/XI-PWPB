...
@section('content')
   ...
   <div class="p-5 sm:ml-64 bg-[#EDE7E8] h-fit">
      <div class="flex items-center">
         <p class="text-black text-2xl mt-16 sm:mt-10 ml-3">Tambah buku</p>
     ...
     <div class="flex-col h-fit mb-4 rounded-md bg-gray-50 dark:bg-gray-800 mt-3 border border-black pl-4 pt-2 pr-4">
        <h1 class="text-black text-2xl font-bold">Add New Book</h1>
      ...
      <form action="/add-book" method="POST" enctype="multipart/form-data" autocomplete="off">
         ...
         <input required id="cover" name="cover" type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
         <div class="mt-1 text-sm text-gray-500 dark:text-gray-300">upload cover buku</div>
         ...
         <ul class="grid w-full gap-6 md:grid-cols-2">
             <li>
                 <input type="radio" id="book" name="book_type" value="book" class="hidden peer/book" required>
               ...
               <li>
                  <input type="radio" id="ebook" name="book_type" value="ebook" class="hidden peer/ebook">
         ...
         <input required type="text" id="author" name="author" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

         <label for="publisher" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-2">Penerbit</label>
         <input required type="text" id="publisher" name="publisher" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
         ...
         <div class="relative w-full">
            ...
            <input required id="date_of_issue"  name="date_of_issue" datepicker datepicker-format="dd/mm/yyyy" datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
          </div>
 

         <label for="summary" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-2">Sinopsis</label>
         <textarea required id="summary" name="summary" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Sinopsis..."></textarea>
         
         <button type="submit" class="text-white bg-[#4B9CD6] hover:bg-[#437ca5] focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 w-full mb-6 mt-5">Upload Buku</button>
      </form>
   </div>
 @endsection