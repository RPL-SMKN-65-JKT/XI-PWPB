 ...
 if ($password == $cpassword) {
  ...
  if (!$result->num_rows > 0) {
   ...
   if ($result) {
    ...
    echo "<script>alert('Eror Ni Bund Ga tau')</script>";
   }
  } else {
   echo "<script>alert('Euy email siapa itu')</script>";
  }
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s"  data-aos="fade-up" data-aos-duration="1000">
                            <div class="feature-item bg-light rounded text-center p-4">
                                ...
                                <hr>
                                <button name="submit" class="btn orange fw-bold m-1">Login</button>
                                </form>
                                <p class="m-0 text-dark">Belum punya akun? <a href="signup.php">Register </a></p>
                        </div>
                    </div>
                </div>
            </div>
