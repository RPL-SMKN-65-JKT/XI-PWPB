...
<form enctype="multipart/form-data" method="POST" action="/user-add" >
  @csrf
    <h1 class=" mb-10 text-base font-semibold leading-7 text-gray-900">Add User</h1>
    <div class="grid grid-cols-3 gap-x-4">
        <div class="flex flex-col gap-1">
            <div class="mb-3">
                <label for="name" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Name</label>
                <input value="{{old('name')}}" name="name" type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan nama user" required>
            </div>
            ...
            <div class="input-box mb-3">
              <label for="imageInput" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Profile</label>
                <img id="imagePreview" hidden alt="Preview" src="" alt="" style="box-shadow: rgba(50, 50, 93, 0.115) 0px 6px 12px -2px,rgba(0, 0, 0, 0.061) 0px 3px 7px -3px; border-radius: 10px; display: ; border: 1px solid rgba(0, 0, 0, 0.161); max-width: 250px; max-height: 250px;"> 
      
                <input value="{{old('profile_image')}}" type="file" accept="image/*" id="imageInput" name="profile_image" class="pt-2 block w-full border-slate-300 text-sm text-slate-500
        ...
        <div class="flex flex-col gap-1">
          <div class="input-box mb-3">
            <label for="username" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Username</label>
                <input value="{{old('username')}}" name="username" type="text" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Username user" required>
          </div>
          <div class="input-box mb-3">
            <label for="email" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Email</label>
            <input value="{{old('email')}}" name="email" type="text" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email user" required>
          </div>
          <div class="input-box">
        ...
        <div class="flex flex-col gap-1">
          <div class="input-box mb-3">
            <label for="password" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Password</label>
                <input value="{{old('password')}}" name="password" type="text" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Password user" required>
          </div>
          <div class="input-box mb-3">
      
                <label class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Phone Number</label>
                <input name="nomorTlp"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="No.Telepon +62" value="{{old('nomorTlp')}}" required />
