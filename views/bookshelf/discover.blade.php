  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto" id="navbarSupportedContent1" data-te-collapse-item>
      ...
      <a class="mb-4 ml-2 mr-5 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-white dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0" href="#">
        <img src="tema/img/65.png" style="height:30px; width:30px;" alt="65 logo" loading="lazy" />
      </a>
...
<hr color="#ECECEC" class="w-full"
        ...
        <div class="flex flex-wrap justify-center space-x-5">
                ...
                <button href="#" class="tag-button mt-7    active">Fiksi</button>
                <button href="#" class="tag-button mt-7  ">Non Fiksi</button>
                <div class="search-container flex sm:justify-between justify-center items-center gap-3 md:w-[70%] w-[90%]">
                  <form class="md:w-[85%] w-[55%]">
        ...
        <p class="tag text-2xl/[128px] mt-9 ml-10 font-bold leading-normal w-800 dark:text-white">Aksi</p>
        <br>
        ...
        <p class="tag text-2xl/[128px] mt-9 ml-10 font-bold leading-normal w-800 dark:text-white">Drama</p>
        <br>
        <div class="row-bookshelf flex flex-wrap sm:justify-start justify-center items-center">
          <div class="column-bookshelf">
            <a href="#">
              <img class=" sm:w-[185px] w-[150px]  rounded-t-lg px-3 max-w-xs transition duration-300 ease-in-out hover:scale-110" src="tema/img/jujutsu.png" alt="" />
            </a>
            <div class="p-3 ">
                <a href="#">
                    <h5 class="text-xl font-['Poppins'] font-[500] tracking-tight text-gray-900 dark:text-white">Jujutsu Kaisen</h5>
                </a>
                <p class="font-normal text-gray-700 dark:text-gray-400">Gege Akutami</p>
                <p class="genre-tag">Comic</p>
            </div>
          </div>
          <div class="column-bookshelf">
            <a href="#">
        ...
        <p class="tag text-2xl/[128px] mt-9 ml-10 font-bold leading-normal w-800 dark:text-white">Romansa</p>
        <br>
        <div class="row-bookshelf flex flex-wrap sm:justify-start justify-center items-center">
          <div class="column-bookshelf ">
            <a href="#">
...
<div class="navbar" id="myNavbar">
  ...
  <a href="/discover" class="active"><i class='bx bx-compass' ></i> Discover</a>
</div>
