...
@section('content')
 <h1 class="pl-5 font-bold text-lg"> Category List </h1>

 <div class="my-5 flex justify-end ">
  <a href="/category-deleted" class="mx-5 mr-2 py-2 px-4 bg-orange-500 text-white font-semibold rounded-lg shadow-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-75">Deleted Categories</a>
  <a href="/category-add" class="mx-5 py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">Add Categories</a>
 </div>
<div>
  @if (session('status'))
  <script>
        ...
        <table class="border-collapse table-fixed w-full text-sm">
          ...
          <tbody class="bg-white dark:bg-slate-800">
            ...
            <tr>
              ...
              <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400"><a class="mx-2 py-2 px-4 rounded-lg bg-green-500 text-white" href="category-edit/{{$item->slug}}">edit</a>
                <a class="mx-2 py-2 px-4 rounded-lg bg-red-500 text-white " href="category-delete/{{$item->slug}}">delete</a>
              </td>
            </tr>
